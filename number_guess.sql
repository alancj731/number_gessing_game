...
CREATE TABLE public.records (
    ...
    user_name character varying(26) NOT NULL,
...
SELECT pg_catalog.setval('public.records_user_id_seq', 1, false);
...
--
-- Name: records records_user_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.records
    ADD CONSTRAINT records_user_name_key UNIQUE (user_name);
